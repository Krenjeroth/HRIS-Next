        ...
        try {
            ...
            if (resp.status === 200) {
                ...
                setValues({
                    ...
                    application_division_id: data.division.id,
                    application_division: data.division.division_name,
                    application_division_autosuggest: data.division.division_name,
                    division_id: data.division.id,
                    division: data.division.division_name,
                    division_autosuggest: data.division.division_name,
