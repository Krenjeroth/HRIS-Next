...
function index(parameter: Props) {
    ...
    return (
        <>
            <div id="drawer-right-example" className={`fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-gray-100 dark:bg-gray-800 ${parameter.showDrawer ? parameter.width : 'translate-x-full'} shadow-xl`}>
