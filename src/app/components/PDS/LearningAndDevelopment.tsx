...
function LearningAndDevelopment() {
    ...
    useEffect(() => {
        setTrainings([...context.initialValues.trainings]);
        ...
        <>
            <div className='grid lg:grid-cols-4 grid-col' >
                ...
                <div className='col-span-4 md:col-span-4'>
                    <span className=' text-blue-600 font-medium text-lg '>VII.  Learning and Development (L&D) Interventions/Training Programs Attended</span>
