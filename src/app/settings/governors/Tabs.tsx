...
function SalaryGradeTabs() {
    ...
    const [title, setTitle] = useState<string>("Governor");
    ...
    useEffect(() => {
        ...
        async function getData() {
            ...
            const resp = await HttpService.post("search-governors", postData);
            if (resp != null) {
    ...
    const getDataById = async (id: number) => {
        try {
            const resp = await HttpService.get("governors/" + id);
    ...
    const onFormSubmit = async (
        ...
        try {
            ...
            if (process == "Add") {
                ...
                const resp = await HttpService.post("governors", postData);
                if (resp.status === 200) {
            ...
            // update
                ...
                const resp = await HttpService.patch("governors/" + id, postData)
                if (resp.status === 200) {
                    let status = resp.data.status;
            ...
            // delete
                ...
                const resp = await HttpService.delete("governors/" + id);
                if (resp.status === 200) {
                    let status = resp.data.status;
                    if (status === "Request was Successful") {
